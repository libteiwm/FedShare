...
module.exports = function(agenda) {
    var job = {
        ...
        run: function(job,done){
            ...
            StopWordService.insertFromFile('stopwords/stopwords_el.txt')
                .then(function(result) {
                    return StopWordService.insertFromFile('stopwords/stopwords_en.txt');
                })
                .then(function(result) {
                    sails.log.info("Successfully added stop words");
                    done();
                })
                .catch(function(err) {
                    sails.log.error("Could no save stop words");
                    done(err);
                })
        }
    };
