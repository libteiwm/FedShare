...
var __normalizeRecords = function(records) {
    ...
    for(var i=0;i<records.length;i++) {
        ...
        var normalizedRecord = __normalizeRecord(record)
...
var __normalizeRecord = function(record) {
...
module.exports = {
    normalizeRecord: __normalizeRecord,
    normalizeRecords: __normalizeRecords
}
